...
export const profile = {
  ...
  role: '소프트웨어 엔지니어',
  intro:
    '좋은 울림을 주는 엔지니어를 지향하고 있어요. 좋은 개발문화를 위한 **Agile, DevOps** 등의 실천 전략에 관심이 많으며, **Web Architecture를 이루는 구성 요소**들에 흥미를 가지고 있습니다. 제가 지향하는 좋은 개발문화에 대한 자세한 이야기는 [여기서](#culture) 확인할 수 있어요.',
};
    ...
    groups: [
      {
        label: '사내 지식 공유 활동',
        items: [
          '[DR 서포터즈](https://techblog.woowahan.com/2666/)',
          '[SQL을 넘어 제플린으로](https://edu.nextstep.camp/c/VulQIb2a/) (사내 오피스·우아한러닝에 등재)',
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    bullets: [
      '셀프서비스는** BFF 특성상 1~20개의 팀(플랫폼)과 협업**해야 하며, 푸드와 커머스 등 다른 프로세스/문화를 가진 조직 간의 통합 프로젝트로 협업 방식을 맞추는 작업을 진행함',
      '프로젝트 중 가게시스템의 구조 개선 등이 병행되어 **200여개의 API가 영향범위**에 놓였으나 일정/영향범위 파악, 업무분장 및 QA 우선순위 안내 등을 통해 일정 내에 프로젝트를 마무리함',
      '푸드와 커머스 등 다양한 플랫폼의 응답을 조합(aggregation)하는 과정에서 **보상트랜잭션, 비동기 처리, 응답구조 공통화, 예외처리 등 구조적 개선**을 통해 서비스 안정성을 높임',
    ],
  },
  {
    title: '우리가게클릭(CPC)',
  ...
  },
  {
    ...
    bullets: [
      '우아한테크코스 교육 사업 마케팅/선발/운영/평가 등 진행 및 [**교육 모델**](https://techblog.woowahan.com/5977/) 설계',
      '커리큘럼 설계/강의/코드리뷰/멘토링 등 진행 및 [**로드맵**](https://github.com/woowacourse/back-end-roadmap) 설계',
    ...
    subProjects: [
      {
        title: '강의 서비스 개발',
        bullets: [
          '코드 리뷰, 리뷰어/팀 매칭, 초대링크 등의 기능을 **페어 프로그래밍**으로 개발하여 도메인 지식 공유',
          '유저 시나리오에 대한 **인수테스트 작성 및 ATDD, DDD 기반으로 개발**하여 견고한 애플리케이션 개발',
          '인증, 인가 정책 설계 및 로직 개선',
        ],
      },
    ],
  ...
  },
  {
    ...
    bullets: [
      ...
      '서비스 **관측 가능성**을 높이기 위해 모니터링 시스템(nagios) 구성 및 자동화',
    ],
  },
];
...
export const values: ValueCard[] = [
  ...
  {
    name: '[DevOps](https://brainbackdoor.tistory.com/71)',
